              ...
              {submitted && (
                <div className="bg-green-900/30 border border-green-700/50 rounded-lg p-4 mb-6 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-200 text-sm">We'll review your request and get back to you soon.</p>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-900/50 border border-slate-600 rounded-lg px-4 py-2 text-white placeholder-slate-500 focus:border-blue-500 outline-none transition"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full bg-slate-900/50 border border-slate-600 rounded-lg px-4 py-2 text-white placeholder-slate-500 focus:border-blue-500 outline-none transition resize-none"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-900/50 border border-slate-600 rounded-lg px-4 py-2 text-white focus:border-blue-500 outline-none transition"
                  >
            ...
            <div className="bg-blue-900/30 border border-blue-700/50 rounded-lg p-6">
              ...
              <ol className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="bg-blue-500 text-white w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold">
                    1
                  </span>
