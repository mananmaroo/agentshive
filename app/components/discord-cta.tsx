...
const DISCORD_INVITE = 'https://discord.gg/4zAEsQJBG';
...
// Compact pill for the navbar, with a pulsing "ping" dot.
export function DiscordCTA() {
  return (
    <Link
      ...
      className="relative inline-flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752c4] text-white px-3 py-2 rounded-lg transition text-sm font-medium"
    >
      <DiscordLogo />
...
export { DiscordLogo, DISCORD_INVITE };
