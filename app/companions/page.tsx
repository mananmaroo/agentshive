...
const companions: Companion[] = [
  ...
  {
    file: 'research-agent-terminal.md',
    title: 'Research Agent',
    tagline: 'It searches multiple sources and hands back a sourced brief, not a link dump.',
    does: [
    ...
    needs: 'Web search',
    platforms: ['Claude', 'OpenAI', 'Perplexity'],
    mcps: ['Filesystem', 'Notion (optional)', 'Slack (optional)'],
    loop: 'Per question, or weekly for a recurring topic',
  },
  {
    file: 'lead-generation-agent-terminal.md',
    title: 'Lead Generation Agent',
    tagline: 'It finds companies matching your ideal customer profile and hands you a ranked list.',
    does: [
    ...
    needs: 'Browser/MCP access for searching',
    platforms: ['Claude', 'OpenAI'],
    mcps: ['Playwright', 'Filesystem', 'CRM (optional)'],
    loop: 'Per campaign, or weekly to stay fresh',
  },
  {
    file: 'website-dev-commented-terminal.md',
    title: 'Commented Website Builder',
    tagline: 'It builds sites as a multi-file bundle with every non-obvious line explained.',
    does: [
    ...
    needs: 'Nothing extra — runs anywhere',
    platforms: ['Claude', 'OpenAI'],
    mcps: ['Filesystem', 'GitHub (optional)'],
    loop: 'Per page or feature request',
  },
  {
    file: 'website-automation-terminal.md',
    title: 'Website Connect & Automate Agent',
    tagline: 'It connects to a live website and automates a recurring task against it.',
    does: [
    ...
    needs: 'API access or a browser MCP',
    platforms: ['Claude', 'OpenAI'],
    mcps: ['Playwright (optional)', 'Filesystem', 'Slack (optional)'],
    loop: 'On the schedule the task needs',
  },
  {
    file: 'website-scraper-agent-terminal.md',
    title: 'Website Crawler & Extractor',
    tagline: 'It crawls a whole site, extracts every page’s content, and can push it live once you say where.',
    does: [
    ...
    needs: 'Python (requests + beautifulsoup4)',
    platforms: ['Claude', 'OpenAI'],
    mcps: ['Filesystem', 'Playwright (optional, for JS-rendered sites)'],
