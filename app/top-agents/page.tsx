                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <div className="flex items-center gap-3">
                      <span className="text-2xl font-bold text-indigo-400 min-w-8">
                        #{index + 1}
                      </span>
                      <h3 className="text-xl font-bold text-white group-hover:text-slate-400 transition">
                        {agent.title}
                      </h3>
                      {agent.verified && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {agent.category.slice(0, 2).map((cat) => (
                      <span
                        key={cat}
                        className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-medium"
                      >
                        {cat}
                      </span>
                    ))}
